...
📸 ফর্ম সাবমিট করে স্ক্রিনশট এডমিন কে পাঠিয়ে দিন। 
এডমিনের ইউজার নেম কিছুক্ষণ পরেই পাবেন
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_type in ['group', 'supergroup']:
        if msg.upper() == "IT" "আমি নতুন মেম্বার" "Assalamu Walaiqum ami new member" "ami new member" "আমি কাজ করতে চাই":
            await update.message.reply_text(f"{user.mention_html()}, কাজের জন্য আমাকে ইনবক্সে (Private Message) 'IT' লিখুন। ভিডিওটি সম্পূর্ণ দেখে, ভিডিওটি উপরে পিন করা আছে।", parse_mode=ParseMode.HTML)
        return
